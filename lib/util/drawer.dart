...
class SCDrawerController {
  SCDrawerController({this.items, @required SCDrawerContent initialPage}) {
    this.page = initialPage;
  }

  List<SCDrawerItem> items;
  Function close;
  Function open;
  SCDrawerContent page;
}

class SCDrawerContent extends StatefulWidget {
...
class SCDrawer extends StatefulWidget {
  SCDrawer({
    Key key,
    this.header,
    this.footer,
  ...
  @override
  _SCDrawerState createState() => _SCDrawerState();
}

class _SCDrawerState extends State<SCDrawer> with TickerProviderStateMixin {
  ...
  List<SCDrawerItem> _getDrawerItems() {
    if (widget.controller.items != null) {
      return widget.controller.items.map((SCDrawerItem item) {
...
class SCDrawerItem extends StatelessWidget {
  SCDrawerItem({this.onPressed, this.text, this.icon});

  SCDrawerItem.initWithPage({this.onPressed, this.text, this.icon, this.alias, this.page});
